         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-bookmark-o" style="color:#2acdb4"> </i> Earn Leave</h3>
                </div>
            ...
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-danger"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#earnmodel" data-whatever="@getbootstrap" class="text-white TypeModal"><i class="" aria-hidden="true"></i> Assign Earned Leave </a></button>
                    </div>
                </div> 
                <div class="row">
                    <div class="col-12">
                                           ...
                                           <?php foreach($earnleave as $value): ?>
                                            <tr>
                                               ...
                                               <td class="jsgrid-align-center">
                                                    <a href="" title="Edit" class="btn btn-sm  waves-effect waves-light deductionmodel" data-id="<?php echo $value->em_id; ?>"><i class="fa fa-pencil"></i></a>
                                                </td>
                                                <?php } ?>
                                            </tr>
                                            <?php endforeach; ?>
