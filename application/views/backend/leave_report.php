...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor"><i class="fa fa-fax" style="color:#2acdb4"> </i> Leave Report</h3>
        </div>
                                ...
                                <div class="card-body">
                                    <form method="post" action="" id="salaryform" class="form-material row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            <input type="submit" class="btn btn-danger" value="Submit" name="submit" id="BtnSubmit">
                                        </div>
                                    </form>
                                </div>
                            </div>
