...
<?php $this->load->view('backend/sidebar'); ?>
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-user-secret" style="color:#2acdb4"></i> <?php echo $basic->first_name .' '.$basic->last_name; ?></h3>
                </div>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                ...
                                <br/>
                                <a href="https://www.facebook.com" class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->skype_id)) echo $socialmedia->facebook ?>" target="_blank"><i class="fa fa-facebook"></i></a>
                                <a href="https://www.twitter.com" class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->skype_id)) echo $socialmedia->twitter ?>" target="_blank"><i class="fa fa-twitter"></i></a>
                                ...
                                <tr>
                                   ...
                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                                    ...
                                    <td class="jsgrid-align-center ">
                                        <a href="#" title="Edit" class="btn btn-sm  waves-effect waves-light education" data-id="<?php echo $value->id ?>"><i class="fa fa-pencil"></i></a>
                                        <a onclick="confirm('Are you sure want to delet this Value?')" href="#" title="Delete" class="btn btn-sm  waves-effect waves-light edudelet"  data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                    <?php } ?>
                                </tr>
                                <?php endforeach; ?>
                               ...
                               <?php foreach($experience as $value): ?>
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center ">
                                       <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                                       <?php } else { ?>
                                        <a href="#" title="Edit" class="btn btn-sm  waves-effect waves-light experience" data-id="<?php echo $value->id ?>"><i class="fa fa-pencil"></i></a>
                                        <a onclick="confirm('Are you sure want to delet this Value?')" href="#" title="Delete" class="btn btn-sm  waves-effect waves-light deletexp" data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                        ...
                                        <form class="row" action="Add_File" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <button type="submit" class="btn btn-danger">Add File</button>
                                                </div>
                                            </div>
                                            <?php } ?>
                                        </form>
                                ...
                                <div class="tab-pane" id="password1" role="tabpanel">
                                    <div class="card-body">
				                                <form class="row" action="Reset_Password_Hr" method="post" enctype="multipart/form-data">
				                                    ...
				                                    <div class="form-actions col-md-12">
                                                    <input type="hidden" name="emid" value="<?php echo $basic->em_id; ?>">                                                   
				                                        <button type="submit" class="btn btn-danger pull-right"> <i class="fa fa-check"></i> Save</button>
				                                    </div>
				                                    <?php } ?>
				                                </form>
                                    </div>
                                           ...
                                           <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    ...
                                                    <?php } ?>                                                   
                                                    <button <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> disabled <?php } ?> type="submit" style="float: right" class="btn btn-danger">Add Salary</button>
                                                </div>
                                                <?php } ?>
                                            </div>                                                		                                    
			                                    </form>
