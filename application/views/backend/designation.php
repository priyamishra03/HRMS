         ...
         <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor"><i class="fa fa-map-o" style="color:#2acdb4"></i> Designation</h3>
                </div>
                ...
                <div class="card card-outline-danger">
                    ...
                    <div class="card-body">
                            <form method="post" action="Save_des" enctype="multipart/form-data">
                                ...
                                <div class="form-actions">
                                    <button type="submit" class=""> <i class="fa fa-check-circle"></i> Save</button>
                                    <button type="button" class=""><i class="fa fa-ban "></i> Cancel</button>
                                </div>
                            </form>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="jsgrid-align-center ">
                                        <a href="<?php echo base_url();?>organization/Edit_des/<?php echo $value->id?>" title="Edit" class="btn btn-sm  waves-effect waves-light"><i class="fa fa-pencil-square"></i></a>
                                        <a onclick="return confirm('Are you sure to delete this data?')"  href="<?php echo base_url();?>organization/des_delete/<?php echo $value->id;?>" title="Delete" class="btn btn-sm btn-delete waves-effect waves-light"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php }?>
                            </tbody>
