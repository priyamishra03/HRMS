            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-danger"><a href="<?php echo base_url(); ?>attendance/Attendance_Report" class="text-white"><i class="" aria-hidden="true"></i> Attendance Report </a></button>
                    </div>
                </div>  
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="Get_attendance_data_for_report" class="form-material row">
                                    ...
                                    <div class="col-md-3 form-group">
                                        <input type="submit" class="btn btn-danger" value="Submit" name="submit" id="getAtdReport">
                                    </div>
                                </form>
                            </div>
                        </div>
