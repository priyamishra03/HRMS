         ...
         <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-danger"><i class="fa fa-plus"></i><a href="<?php echo base_url(); ?>attendance/Attendance" class="text-white"><i class="" aria-hidden="true"></i>  Attendance List</a></button>
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                    ...
                                    <input type="hidden" name="id" value="<?php if(!empty($attval->id)){ echo  $attval->id;} ?>" class="form-control" id="recipient-name1">                                       
                                        ...
                                        <button type="submit" id="attendanceUpdate" class="btn btn-danger">Submit</button>
                                    </div>
                                    </form>
                            </div>
                        </div>
